     ...
     dashboardBody(
              ...
              tabsetPanel(
                         ...
                         tabPanel(
                                  ...
                                  fluidRow(
                                    column(width = 4,box(
                              title = "SV prediction plot", width = NULL, solidHeader = TRUE,status = "primary", lineupOutput("lineup1") )),  column(width = 8,plotlyOutput("distPlot1", width = 800, height = 400)),
                                  fluidRow(
                                    column(width = 12,wellPanel(htmlOutput("text"))   ) )
                                          )
                                  )
                         )
                 )  
